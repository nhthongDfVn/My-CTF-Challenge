...
<head>
	<meta charset="utf-8">
	<title>Trigonometric Formula v1.0 | ANHTOICTF 2021</title>
</head>
...
<?php
$code_array=get_defined_functions();
$code_array=$code_array['internal'];
foreach($code_array as $value){
	if(preg_match("/^[sincoeta0123456789*\/^~+-]+$/i", $value))
	{
	   //echo $value."</br>";
	}
}
